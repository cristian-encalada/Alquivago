  ...
  export function Header() {
    return (
      <header className="from-azul-200 gap-2 to-white flex h-[50vh] flex-col items-center justify-center bg-opacity-60 bg-gradient-to-b bg-blend-multiply lg:flex lg:h-[60vh] lg:w-full lg:flex-col lg:items-center lg:justify-center lg:bg-cover lg:bg-center">
