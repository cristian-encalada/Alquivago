...
export default function TypeButton() {
  ...
  function applyFilters() {
    ...
    return router.push(`/publish/tipos=${filters.join(',')}`)
  }
  ...
  return (
    <div className="flex flex-col w-32 gap-1">
      ...
      <div className="flex flex-col w-full border-2 border-slate-300 rounded-lg bg-white shadow-lg">
        <ul>
          <li>
            <input type="checkbox" value="4" onClick={handleClick} checked={filters.includes("4")} />
            Casa
          </li>
          <li>
            <input type="checkbox" value="0" onClick={handleClick} checked={filters.includes("0")} />
            Apartamento
          </li>
          <li>
            <input type="checkbox" value="2" onClick={handleClick} checked={filters.includes("2")} />
            Local
          </li>
        </ul>
