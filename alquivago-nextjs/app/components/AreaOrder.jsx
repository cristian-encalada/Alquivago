...
export default function AreaOrder({ children, orders, setOrders }) {
    ...
    function handleOrder(e) {
        ...
        if (!orders.includes(value)) {
          let updatedOrders = orders.filter(order => !order.startsWith('area')); // Eliminar cualquier opción de precio existente
